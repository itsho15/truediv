...
function td_excerpt_length( $length ) {
    $length = Cs_option()['excerpt_length'];
	return $length;
}
...
function smittenkitchen_cat_count_span( $links ) {
	$links = str_replace( '</a> (', '</a><span class="td-post-count">', $links );
...
// Pagination
function td_pagination_index($content) {
...
add_action('navigation_markup_template', 'td_pagination_index');
...
// Breadcrumbs
function td_breadcrumbs() {
       
    // Settings
    $separator          = '<i class="fa fa-angle-right"></i>';
    $breadcrums_id      = 'td_breadcrumbs';
    $breadcrums_class   = 'td-breadcrumbs';
    $home_title         = 'Homepage';
